                ...
                <strong>
                  <span style={{ fontSize: "15px" }}>
                    <span data-custom-class="subtitle">
                      Last updated{" "}
                      <bdi className="question">August 10, 2022</bdi>
                    </span>
                  </span>
                </strong>
              </span>
              ...
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
                  ...
                  <span data-custom-class="body_text">
                    ...
                    and/or share (<bdi className="block-component" />'
                    <strong>process</strong>'<bdi className="else-block" />)
                ...
                <li style={{ lineHeight: "1.5" }}>
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        Download and use
                        <bdi className="block-component" /> our mobile
                        application
                        <bdi className="block-component" /> (
                ...
                <span style={{ fontSize: "15px" }}>
                  <span style={{ color: "rgb(127, 127, 127)" }}>
                    <span data-custom-class="body_text">
                      ...
                      <bdi className="question">info@troberapp.com</bdi>.
                    </span>
                  </span>
                </span>
              </div>
              ...
              <div style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    ...
                    with <bdi className="block-component" />
                    <bdi className="question">Trober</bdi>
                    <bdi className="statement-end-if-in-editor" /> and the
                ...
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    <strong>
                      ...
                      <bdi className="block-component" />
                      types of <bdi className="statement-end-if-in-editor" />
                      parties do we share personal information?
                    </strong>{" "}
                    We may share information in specific situations and with
                    specific <bdi className="block-component" />
                    categories of <bdi className="statement-end-if-in-editor" />
                    third parties. Click&nbsp;
                  </span>
                </span>
              ...
              <div style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    ...
                    have <bdi className="block-component" />
                    organisational
                    <bdi className="else-block" /> and technical processes and
                    ...
                    cybercriminals, or other <bdi className="block-component" />
                    unauthorised
                    <bdi className="else-block" /> third parties will not be
              ...
              <div style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    ...
                    easiest way to exercise your rights is by filling out our
                ...
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    <bdi className="block-component" />, or by contacting us. We
              ...
              <div style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdi className="block-component" />
                    <bdi className="question">Trober</bdi>
                    <bdi className="statement-end-if-in-editor" /> does with any
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        <span style={{ fontSize: "15px" }}>
                          <span data-custom-class="body_text">
                            <bdi className="question">names</bdi>
                          </span>
                        </span>
                      </span>
                    </span>
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        <span style={{ fontSize: "15px" }}>
                          <span data-custom-class="body_text">
                            <bdi className="question">phone numbers</bdi>
                          </span>
                        </span>
                      </span>
                    </span>
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        <span style={{ fontSize: "15px" }}>
                          <span data-custom-class="body_text">
                            <bdi className="question">email addresses</bdi>
                          </span>
                        </span>
                      </span>
                    </span>
                ...
                <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      ...
                      <bdi className="question">Paystack</bdi>
                      <span
                        style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}
                      >
                        <span
                ...
                <li style={{ lineHeight: "1.5" }}>
                  <span style={{ fontSize: "15px" }}>
                    <span data-custom-class="body_text">
                      ...
                      <bdi className="forloop-component" />
                      <bdi className="question">camera</bdi>,{" "}
                      <bdi className="forloop-component" />
                      <bdi className="question">storage</bdi>,{" "}
                      <bdi className="forloop-component" />
                    ...
                    >
                      ...
                      >
                        <span data-custom-class="body_text">
                          ...
                          <span style={{ fontSize: "15px" }}>&nbsp;</span>(such
                          as the date/time stamps associated with your usage,
                          pages and files viewed, searches, and other actions
                          you take such as which features you use), device event
                          information (such as system activity, error reports
                          (sometimes called <bdi className="block-component" />
                          'crash dumps'
                          <bdi className="else-block" />
                                ...
                                <li style={{ lineHeight: "1.5" }}>
                                  ...
                                  >
                                    ...
                                    >
                                      <span data-custom-class="body_text">
                                        <strong>
                                          To <bdi className="block-component" />
                                          fulfil
                                        ...
                                        fulfil
                                        <bdi className="else-block" /> and
                                        manage your orders, payments, returns,
