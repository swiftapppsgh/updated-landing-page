                    ...
                    <div data-custom-class="body">
                        ...
                        <div style={{ lineHeight: "1.5" }}>
                            <span style={{ color: "rgb(127, 127, 127)" }}>
                                ...
                                >
                                    <span data-custom-class="body_text">
                                        ...
                                        <bdi className="question">Trober</bdi>
                                        <span
                                            style={{ color: "rgb(89, 89, 89)" }}
                                        >
                                            <span data-custom-class="body_text">
                                                <bdi className="block-component" />
                                            </span>
                                        </span>{" "}
                                        (<bdi className="block-component" />'
                                        <bdi className="block-component" />
                                        <strong>Company</strong>
                                        <bdi className="statement-end-if-in-editor" />
                                        ', '<strong>we</strong>', '
                                        <strong>us</strong>', or '
                                        <strong>our</strong>',
                                        <bdi className="else-block" />
                                    </span>
                                    <span data-custom-class="body_text">
                                        ), describes how and why we might
                                        collect, store, use, and/or share (
                                        <bdi className="block-component" />'
                                        <strong>process</strong>'
                                        <bdi className="else-block" />) your
                                ...
                                <span style={{ fontSize: "15px" }}>
                                    ...
                                    >
                                        <span data-custom-class="body_text">
                                            ...
                                            Reading this privacy notice will
                                    ...
                                    <span data-custom-class="body_text">
                                        <strong>
                                            <em>
                                                ...
                                                from our privacy notice, but you
                                                can find out more details about
                                                any of these topics by clicking
                                                the link following each key
                                                point or by using our table of
                                                contents below to find the
                                                section you are looking for. You
                                                can also click&nbsp;
                                            </em>
                                        </strong>
                                    </span>
                            ...
                            <div style={{ lineHeight: "1.5" }}>
                                <span style={{ fontSize: "15px" }}>
                                    <span data-custom-class="body_text">
                                        ...
                                        <bdi className="block-component" />
                                        organisational
                                        <bdi className="else-block" /> and
                                        technical processes and procedures in
                                        ...
                                        <bdi className="block-component" />
                                        unauthorised
                                        <bdi className="else-block" /> third
                            ...
                            <div style={{ lineHeight: "1.5" }}>
                                <span style={{ fontSize: "15px" }}>
                                    <span data-custom-class="body_text">
                                        ...
                                        is by filling out our data subject
                                ...
                                <a
                                    data-custom-class="link"
                                    href="https://app.termly.io/notify/2df55b07-28f3-486b-80d7-762dde384762"
                                ...
                                <span style={{ fontSize: "15px" }}>
                                    <span data-custom-class="body_text">
                                        <bdi className="block-component" />, or
                                        by contacting us. We will consider and
                                ...
                                >
                                    ...
                                    >
                                        <span data-custom-class="body_text">
                                            ...
                                            <span style={{ fontSize: "15px" }}>
                                                <span data-custom-class="body_text">
                                                    <bdi className="forloop-component" />
                                                </span>
                                            </span>
                                        </span>
                                    </span>
                                            ...
                                            >
                                                ...
                                                >
                                                    <span data-custom-class="body_text">
                                                        ...
                                                        <bdi className="question">
                                                            <a
                                                                href="https://paystack.com/gh/privacy/merchant#:~:text=Paystack%20does%20not%20sell%2C%20trade"
                                                                target="_blank"
                                                                data-custom-class="link"
                                                            >
                                                                https://paystack.com/gh/privacy/merchant#:~:text=Paystack%20does%20not%20sell%2C%20trade
                                                            </a>
                                                            ,described%20in%20this%20Privacy%20Policy.
                                                        </bdi>
                                                        <span
                                                            style={{
                                                                fontSize:
                            ...
                            <div style={{ lineHeight: "1.5" }}>
                                <span data-custom-class="body_text">
                                    <span style={{ fontSize: "15px" }}>
                                        <strong>Application Data.</strong> If
                                        you use our application(s), we also may
                                        collect the following information if you
                                        choose to provide us with access or
                                        permission:
                                        <bdi className="block-component" />
                                    </span>
                                </span>
                            ...
                            <ul>
                                <li style={{ lineHeight: "1.5" }}>
                                    <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                            <em>Geolocation Information.</em> We
                                            may request access or permission to
                                            track location-based information
                                            from your mobile device, either
                                            continuously or while you are using
                                            our mobile application(s), to
                                            provide certain location-based
                                            services. If you wish to change our
                                            access or permissions, you may do so
                            ...
                            <ul>
                                <li style={{ lineHeight: "1.5" }}>
                                    <span style={{ fontSize: "15px" }}>
                                        <span data-custom-class="body_text">
                                            <em>Mobile Device Access.</em> We
                                            may request access or permission to
                                            certain features from your mobile
                                            device, including your mobile
                                            device's{" "}
                                            <bdi className="forloop-component" />
                                            <bdi className="question">
                                                camera
                                            ...
                                            ,{" "}
                                            <bdi className="forloop-component" />
                                            and other features. If you wish to
                                            change our access or permissions,
                                            you may do so in your device's
                                            settings.
                                            <bdi className="statement-end-if-in-editor" />
                                        </span>
                                    </span>
                            ...
                            <div style={{ lineHeight: "1.5" }}>
                                ...
                                <ul>
                                    <li style={{ lineHeight: "1.5" }}>
                                        <span style={{ fontSize: "15px" }}>
                                            <span data-custom-class="body_text">
                                                <em>Push Notifications.</em> We
                                                may request to send you push
                                                notifications regarding your
                                                account or certain features of
                                                the application(s). If you wish
                                                to opt out from receiving these
                                                types of communications, you may
                                                turn them off in your device's
                                                settings.
                                                <bdi className="statement-end-if-in-editor" />
                                            </span>
                                        </span>
                                    ...
                                    >
                                        ...
                                        >
                                            <span data-custom-class="body_text">
                                                ...
                                                you provide to us must be true,
                                                complete, and accurate, and you
                                                must notify us of any changes to
                                    ...
                                    >
                                        ...
                                        >
                                            <span data-custom-class="body_text">
                                                ...
                                                information when you visit, use,
                                                or navigate the Services. This
                                                information does not reveal your
                                                specific identity (like your
                                                name or contact information) but
                                                may include device and usage
                                        ...
                                        >
                                            ...
                                            >
                                                <span data-custom-class="body_text">
                                                    ...
                                                    Log and usage data is
                                                    service-related, diagnostic,
                                                    usage, and performance
                                                    information our servers
                                                    automatically collect when
                                                    you access or use our
                                                    Services and which we record
                                                    in log files. Depending on
                                                    ...
                                                    usage, pages and files
                                                    viewed, searches, and other
                                                    actions you take such as
                                                    which features you use),
                                                    device event information
                                                    (such as system activity,
                                                    error reports (sometimes
                                                    called{" "}
                                                    <bdi className="block-component" />
                                                    'crash dumps'
                                                    <bdi className="else-block" />
                                            ...
                                            >
                                                ...
                                                >
                                                    <span data-custom-class="body_text">
                                                        ...
                                                        we may use GPS and other
                                                        technologies to collect
                                                        geolocation data that
                                                        tells us your current
                                                        location (based on your
                                                        IP address). You can opt
                                                        out of allowing us to
