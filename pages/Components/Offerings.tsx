...
const Offerings = () => {
    return (
        <div className="bg-primary py-28 mb-24 sm:mb-44">
            ...
            <div className="flex flex-col items-center justify-center md:justify-around md:flex-row">
                <div className="flex flex-col justify-center items-center mt-10 sm:mt-0">
                    ...
                    <div className="flex flex-col text-white  w-10/12 text-center">
                        ...
                        <p className="">
                            Track your ride in real time and know an estimate of
                            the pickup time
                        </p>
                    </div>
                </div>
                <div className="flex flex-col justify-center items-center mt-10 sm:mt-0">
                    ...
                    <div className="flex flex-col text-white  w-10/12 text-center">
                        ...
                        <p className="">
                            To increase ridership, we use data to determine and
                            optimize fixed bus routes.
                        </p>
                    </div>
                </div>
                <div className="flex flex-col justify-center items-center mt-10 sm:mt-0">
                    ...
                    <div className="flex flex-col text-white  w-10/12 text-center">
                        ...
                        <p className="">
                            No need to carry physical cash. Connect your digital
                            wallet and pay as you ride.
                        </p>
                    </div>
                </div>
                <div className="flex flex-col justify-center items-center mt-10 sm:mt-0">
                    ...
                    <div className="flex flex-col text-white  w-10/12 text-center">
                        ...
                        <p className="">
                            Request for a ride in seconds. The booking process
                            is simplified to save you time
                        </p>
                    </div>
                </div>
            </div>
